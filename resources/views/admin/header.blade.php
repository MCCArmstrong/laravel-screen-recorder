    ...
    <div class="container-fluid">
        <div class="row gutters">
            <div class="col-xl-5 col-lg-5 col-md-5 col-sm-3 col-4">
                ...
                <a href="#" class="logo">
                    <img src="{{asset('admin-layout/img/unify.png')}}" alt="FaceDrip" />
                </a>
            </div>
                  ...
                  <li>
                    ...
                    <div class="progress">
                                        <div class="progress-bar bg-danger" role="progressbar" aria-valuenow="42" aria-valuemin="0" aria-valuemax="100" style="width: Unify Admin Dashboard="icon-chevron-small-down"></i>
                        </a>
